...
name = st.sidebar.multiselect("Select the office", options=load_df['Name'].unique(), default=load_df['Name'].unique())
...
try:
    ...
    for i, row in df.iterrows():
        ...
        <li class="list-group-item"><h4>Total Price: {row['TotalPrice']} USD</h4><br></li>
    ...
    # Move the map and data section outside the expander to avoid nesting
    ...
    st.error(f"Unable to display data. Error: {str(e)}. Select at least one business location.")
